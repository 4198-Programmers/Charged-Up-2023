...
public class CANSparkMotor {
   ...
   */
  public CANSparkMotor(CANSparkMax motor, boolean isDriveMotor)
  {
    this.motor = motor;
   ...
   * @param isDriveMotor Is the motor being initialized a drive motor?
   */
  public CANSparkMotor(int id, boolean isDriveMotor)
  {
   ...
   */
  public CANSparkMotor setAbsoluteEncoder(CANCoderEncoder encoder)
  {
