...
public class WithMarker extends CommandBase{
    ...
    public WithMarker(DriveTrain driveTrain, PathHolder pathHolder){
        ...
        addRequirements(driveTrain, pathHolder);
    }

    @Override
    public void initialize() {
        command = new FollowPathWithEvents(new RunPathAuto(pathHolder, driveTrain), pathHolder.getPathMarks(), pathHolder.getPathEventMap());
    }
